...
public class AWorld {
    ...
    public AWorld(String name, String uuid, String message, String prefix, Difficulty difficulty, GameMode gamemode, boolean monsters, boolean animals, boolean pvp, Location<World> spawn, double border, double borderdamage) {
        this.name = name;
        this.uuid = uuid;
