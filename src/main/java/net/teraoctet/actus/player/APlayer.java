...
public class APlayer{
    ...
    public APlayer(String uuid, int level, String name, String godmode, double flymode, String mails, double money, String lastposition, String lastdeath, double onlinetime, double lastonline, String jail, double timejail, int id_guild, int guild_rank ) {
        this.uuid = uuid;
        this.level = level;
        this.name = name;
    ...
    public void setID_guild(int id_guild) { this.id_guild = id_guild; }
    public void setFactionRank(int guild_rank) { this.guild_rank = guild_rank; }

    public void setHome(String name, Home home) { if(homes == null) homes = new HashMap<>(); homes.put(name, home); }
    public void setHomes(HashMap<String, Home> homes) { if(homes == null) homes = new HashMap<>(); this.homes = homes; }
    ...
    public void removeHome(String name) { if(homes.containsKey(name)) homes.remove(name); }
    public HashMap<String, Home> getHomes() { if(homes == null) homes = new HashMap<>(); return homes; }
